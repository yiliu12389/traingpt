...
class MLP(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.c_proj.NANOGPT_SCALE_INIT = 1 # a flag for this module 
...
#simple launch: torchrun --standalone --nproc_per_node=8 train_gpt2.py
...
if checkpoint_path and  os.path.exists(checkpoint_path):
    ...
    train_loader.current_shard = checkpoint['shard']
...
#once in a while evaluage validation loss
